...
import saiful from "../../assets/OutTeam/SaifulIslam.jpg";
import ruhul from "../../assets/OutTeam/RuhulAmin.jpg";
import sajib from "../../assets/OutTeam/SajibPaul.jpg";
import Nayan from "../../assets/OutTeam/NayanKhan.jpg";
import munir from "../../assets/OutTeam/MunirHossain.jpg";
import minhaj from "../../assets/OutTeam/MinhajurRahman.jpg";
import hasan from "../../assets/OutTeam/HasanAlMamun.jpg";
import Rasel from "../../assets/OutTeam/RaselHossain.jpg";
import Ejaj from "../../assets/OutTeam/EjajMolla.jpg";
    ...
    <div className="min-h-screen">
        ...
        <div>
          <div className="flex">
            <div className="">
              ...
              <h1 className="text-5xl font-bold text-orange-400">Message</h1>
            </div>
            <div className="">
              <img
          ...
          <p className="text-justify">
            ...
            profound vision to transform travel into a transformative art, where
            each destination visited leaves an indelible mark on your heart and
            mind. Sayful Islam As a visionary Recruitment veteran, with over 10
            years of comprehensive experience in global recruitment process. We
            are equipped with powerful integrated recruitment technologies and
            have a. team of seasoned expert recruiters. We have all the latest
            facilities in the areas of communication, frequent transport etc.,
            and leading to expedition of the entire process. Additionally, all
            of our recruiters have significant management experience. They
            understand the job requirement completely and appreciated that it is
            the human resources that the backbone of an organization, success.
          </p>
        </div>
        <div>
          <div className="flex">
            ...
            <div className="">
              <img className="w-[200px] rounded-full" src={ruhul} alt="image" />
            </div>
          </div>
          ...
          <p className="text-justify">
            Communication, Connection and attitude of giving honest service are
            true keys to success in any field/endeavor and, it is ‘the most
            relevant strength of business. Accordingly we are determined to
            bring success in our business where our esteemed clients are our
            products and life line. We are promised and dedicated to provide
            legendary support and services to our valued customers as we pledge
            them. We do respect the demands of our guests like our VIPs to earn
            their faith and satisfaction through providing world-class support
            and services. Beginning with your first step into our lounge (lobby)
            will make you confident about our work ethic and standards of our
            excellence. And I am certain that you will be our ambassador from
            the next morning. Hereby I welcome and invite you to see, feel and
            enjoy our services to experience our sincerity and genuineness in
            bringing your success by making your dream come true. Let us work
            together to touch the sky of your dream of success. With profound
            regards.
          </p>
        </div>
        <div>
          <div className="flex">
            ...
            <div className="">
              <img className="w-[200px] rounded-full" src={sajib} alt="image" />
            </div>
          </div>
          ...
          <p className="text-justify">
            ...
            people who live and work in it. – “Dee Hock” <br /> I believe in
            this valuable quote because throughout my 20 years of career
            ...
            hospitality veteran, with over 20 years of comprehensive experience
            in maximizing resources and improving the bottom line through expert
            leadership in quality service, staff development, cost control, and
            visionary P&L management for leading multiservice hotels and resort
            groups across international geographies. Innately wired for
            strategic and tactical thinking, always I try my best to implement
            best practices with a strong sense of urgency, responsibility, and
            accountability to surpass customer expectations and establish
            enduring brands from scratch.
          </p>
        </div>
        <div>
          <div className="flex">
            ...
            <div className="">
              <img className="w-[200px] rounded-full" src={Nayan} alt="image" />
            </div>
          </div>
          <h5 className="text-2xl font-bold text-red-800">Nayan Khan</h5>
          <p className="text-justify">
            Commitment needs to be on top priority... I tried to implement
            during my journey, over 14 years in the global recruitment process,
            and visa processing for different countries, expert in BMET
            immigration clearance card issues. I began my career in recruitment
            and executive search over 14 years. I’m dedicated and committed to
            excellence. I can understand the needs of my clients and candidates.
            I have a consultative approach and attract top-caliber
            different-level candidates. I enjoy working with candidates and
            clients. With our global recruitment services, we assist businesses
            in expanding their global workforce. Our experts guide you through
            the intricacies of international hiring, immigration, and
            compliance. We ensure that your overseas employees are hired
            efficiently and integrated seamlessly into your global operations
          </p>
        </div>
      </div>
      <div className="grid grid-cols-4 gap-4 mt-24">
        <div className="text-center">
          <img
            className="rounded-full w-[200px] h-[250px]  mx-auto "
            src={munir}
            alt="image"
          />
          <h1 className="text-red-800 font-bold text-2xl">MD Monir Hossain</h1>
          <p>Business Development Director</p>
        </div>
        <div className="text-center">
          <img
            className=" mx-auto rounded-full  w-[200px] h-[250px] "
            src={minhaj}
            alt="image"
          />
        ...
        <div className="text-center">
          <img  className=" mx-auto rounded-full  w-[200px] h-[250px] " src={hasan} alt="image" />
          <h1 className="text-red-800 font-bold text-2xl">MD Hasan Al Mamun</h1>
          <p>Engineer</p>
        </div>
        <div className="text-center">
          <img  className=" mx-auto rounded-full  w-[200px] h-[250px] " src={Rasel} alt="image" />
          <h1 className="text-red-800 font-bold text-2xl">Rasel Hossain</h1>
          <p>Embassy Liaison / Accountant</p>
        </div>
        <div className="text-center">
          <img  className=" mx-auto rounded-full  w-[200px] h-[250px] " src={Ejaj} alt="image" />
          <h1 className="text-red-800 font-bold text-2xl">Ejaj Molla</h1>
